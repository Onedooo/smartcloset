...
def real(url):
    path = "media/images/" + "test3.jpg"
    urllib.request.urlretrieve(url, path)
    img = 'media/images/test3.jpg'
    ...
    path_hubconfig = "yolov5_code"  # yolov5 폴더 루트
    path_weightfile = "yolov5_code/train_file/best.pt"  # yolov5 가중치로 학습한 pt파일위치
